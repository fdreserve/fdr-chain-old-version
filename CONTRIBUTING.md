Contributing to FDReserve Core
============================

The FDReserve Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FDReserve Core project, and is not to be
confused with overall FDReserve Network Protocol consensus changes.

Whether a pull request is merged into FDReserve Core rests with the project merge
...
Patches that change FDReserve consensus rules are considerably more involved than
...
Where a patch set proposes to change the FDReserve consensus, it must have been
...
The project leader is the release manager for each FDReserve Core release.
