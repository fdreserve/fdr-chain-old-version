...
FDReserve now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<fdreserve_address\> \<monthly_payment_fdreserve\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ FDReserve, _12_ times over the course of a year totaling _24000_ FDReserve.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<fdreserve_address\> \<monthly_payment_fdreserve\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` FDReserve.
