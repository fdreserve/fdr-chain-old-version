...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total fdreserve balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zFDRsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zFDR denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zFDR denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zFDR denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zFDR denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zFDR denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zFDR denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zFDR denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zFDR denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zFDR denominations\n"
            "  }\n"
    ...
    Object zfdreserveObj;
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zfdreserveObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zfdreserveObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zFDRsupply", zfdreserveObj));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"fdreserveaddress\"     (string, required) The fdreserve address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"fdreserveaddress\", (string) The fdreserve address validated\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"fdreserveaddress\"  (string, required) The fdreserve address to use for the signature.\n"
