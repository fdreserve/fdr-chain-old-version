                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FDReserve Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FDReserve address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fdreserve: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFDR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FDReserve Core"), this);
    aboutAction->setStatusTip(tr("Show information about FDReserve Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FDReserve"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FDReserve addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FDReserve addresses"));
    ...
    openAction->setStatusTip(tr("Open a FDReserve: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FDReserve Core help message to get a list with possible FDReserve command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FDReserve Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FDReserve network", "", count));
}
...
{
    QString strTitle = tr("FDReserve Core"); // default title
...
/** Creates context menu, its actions, and fdreserves up all the relevant signals for mouse events. */
