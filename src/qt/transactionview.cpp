                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received FDReserve from zFDR"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zFDR"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zFDR));
