...
/** Utility functions used by the FDReserve Qt UI.
 */
namespace GUIUtil
{
...
// Render FDReserve addresses in monospace font
...
// Parse "fdreserve:" URI into recipient object, return true on successful parsing
