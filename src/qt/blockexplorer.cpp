...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::FDRESERVE, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            ...
            QMessageBox::warning(this, "FDReserve Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
