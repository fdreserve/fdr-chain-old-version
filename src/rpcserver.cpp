...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop FDReserve server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "FDReserve server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FDReserve features */
        {"fdreserve", "masternode", &masternode, true, true, false},
        {"fdreserve", "listmasternodes", &listmasternodes, true, true, false},
        {"fdreserve", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fdreserve", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fdreserve", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fdreserve", "masternodedebug", &masternodedebug, true, true, false},
        {"fdreserve", "startmasternode", &startmasternode, true, true, false},
        {"fdreserve", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fdreserve", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fdreserve", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fdreserve", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fdreserve", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fdreserve", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fdreserve", "mnbudget", &mnbudget, true, true, false},
        {"fdreserve", "preparebudget", &preparebudget, true, true, false},
        {"fdreserve", "submitbudget", &submitbudget, true, true, false},
        {"fdreserve", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fdreserve", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fdreserve", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fdreserve", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fdreserve", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fdreserve", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fdreserve", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fdreserve", "checkbudgets", &checkbudgets, true, true, false},
        {"fdreserve", "mnsync", &mnsync, true, true, false},
        {"fdreserve", "spork", &spork, true, true, false},
        {"fdreserve", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"fdreserve", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
